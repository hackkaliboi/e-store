              ...
              <Card className="border-0 shadow-sm bg-white">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-900/70">+2348036406671</p>
                  </div>
                  <div>
                    <h3 className="font-medium text-amber-900 mb-1">Order on WhatsApp</h3>
                    <p className="text-amber-900/70">Click below to message us on WhatsApp for orders</p>
                    <a
